...
export async function jugadores_Jugada(props) {
    return /* html */ `
      <div id="ContendorJugada" style="display: flex;width: 27%;height: 142px;justify-content: center;background:  #D5E8D4;flex-wrap: wrap;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;margin-left: 19px;margin-bottom: 8px;">
      ...
      <div class="col-md-8">
          ...
          <div id="ContenedorPanelJugadoresJugador" style="display: flex;max-width: 44%;width: 44%;height: 250px;/*! justify-content: space-evenly; */align-items: center;flex-wrap: wrap;margin-left: 1%;gap: 14px;">
              ...
              <div id="contenedorJugadores"style="display: flex;width: 61%;height: 64%;justify-content: center;background: #D5E8D4;flex-wrap: wrap;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;margin-bottom: 10px;">
                  ...
                  <div id="contenedorControlReproductor" style="display: flex;width: 27%;height: 120px;justify-content: center;background:  #D5E8D4;flex-wrap: wrap;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;margin-left: 18px;margin-bottom: 48px;">
  ...
  export async function cancha(props) {
    return /* html */ `
    <div id="contenedor-animation" style="width:70%;height: 789px;display:flex;justify-content: center;align-content: center;align-items: center;margin-left: 29%;margin-top: -735px;">
